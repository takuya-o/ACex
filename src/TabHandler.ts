...
import { BackgroundMsgCmd, TabId } from './Types'
import { MessageUtil } from './MessageUtil'

export class TabHandler {
  public static assignMessageHandlers() {
    chrome.runtime.onMessage.addListener(
      (msg: string, _sender: chrome.runtime.MessageSender, sendResponse: (res?: unknown) => void) => {
  ...
  private static removeTab(tabId: number) {
